...
class RetencionesController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($buscar==''){
            ...
            ->select('retenciones.id','retenciones.retencion','retenciones.cuenta as id_cuenta','plan_cuentas.nombre as cuenta','plan_cuentas.codigo as codigo_cuenta','retenciones.autoretenedor','retenciones.declarante','retenciones.monto_base','retenciones.tipo_mov','retenciones.estado')
            ->orderBy('id', 'desc')
            ->paginate(6);
        }
        else{
