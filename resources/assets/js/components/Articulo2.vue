                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="articulo in arrayArticulo" :key="articulo.id">
                                    ...
                                    <td>
                                        <template>
                                            <button v-if="articulo.condicion" type="button" @click="abrirModal('articulo','actualizar',articulo)" class="btn btn-warning btn-sm">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <label class="form-control-label col-md-3 float-left" for="text-input">Categoría 2</label>
                                    <div class="col-md-9 float-right">
                                        <select class="form-control col-md-10 float-left" v-model="idcategoria2">
                                            <option value="0" disabled>Seleccione</option>
                                    ...
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        <tbody>
                                            <tr v-for="tarifario in arrayTarifarios" :key="tarifario.id">
                                                ...
                                                <td><input type="number" v-model="tarifario.valor"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <!--<nav>
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label class="col-md-1 form-control-label float-left" for="text-input">Nombre</label>
                                        <div class="col-md-11 float-right">
                                            <input type="text" v-model="nombreCategoria1" class="form-control float-right" style="width: 96%;" placeholder="Nombre de categoría">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-11 float-right">
                                            <textarea v-model="descripcionCategoria1" class="form-control float-right" style="width: 96%;"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
...
<script>
    ...
    export default {
        ...
        methods : {
            ...
            selectCategoria2(){
                let me=this;
                var url= this.ruta + '/categoria2/selectCategoria';
                axios.get(url).then(function (response) {
                    //console.log(response);
                    var respuesta= response.data;
            ...
            abrirModalCrear(accion2){
                ...
                switch(accion2){
                    ...
                    {   
                        this.modal4 = 1;
                        this.tituloModal4 = 'Crear categoria 1';
                        break;
                    }
                    case "categoria2":
                    {   
            ...
            registrarCategoria(){
                ...
                axios.post(this.ruta +'/categoria/registrar',{
                    'nombre': this.nombreCategoria1,
                    'descripcion': this.descripcionCategoria1,
